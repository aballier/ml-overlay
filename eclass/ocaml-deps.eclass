...
declare -A -g _GLOBAL_OCAML_DEPS=(
	...
	[ANSITerminal]=""
	[asn1-combinators]="cstruct zarith bigarray-compat stdlib-shims ptime"
	[astring]=""
	...
	[ca-certs]="bos fpath rresult ptime mirage-crypto x509 logs astring"
...
js_of_ocaml-tyxml lwt_log lwt_ppx tyxml ocsigenserver ipaddr reactiveData ppxlib"
	...
	[js_of_ocaml-compiler]="cmdliner yojson menhir ppxlib findlib"
	...
	[num]=""
	[ocamlbuild]=""
	[ocamlformat]="base menhir cmdliner fix fpath ppxlib odoc re stdio uuseg uutf dune-build-info ocaml-version menhirLib menhirSdk"
...
domain-name fmt lwt ptime mirage-crypto-ec rresult hkdf logs"
	...
	[wtf8]=""
	[x509]="cstruct asn1-combinators ptime base64 mirage-crypto mirage-crypto-pk mirage-crypto-ec mirage-crypto-rng pbkdf rresult fmt gmap domain-name logs"
	[xmldiff]="xmlm"
	[xmlm]=""
	[xml-light]=""
...
declare -A -g _GLOBAL_OCAML_TEST_DEPS=(
	...
	[ppx_protocol_conv_msgpack]="alcotest ppx_sexp_conv sexplib"
	...
	[uri-sexp]="ounit2"
	[uucp]="uucd uunf uutf"
	[x509]="alcotest cstruct-unix mirage-crypto-pk"
