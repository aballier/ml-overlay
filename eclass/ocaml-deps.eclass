...
declare -A -g _GLOBAL_OCAML_DEPS=(
	...
	[ANSITerminal]=""
	[arp]="cstruct duration ethernet fmt ipaddr logs lru lwt macaddr mirage-sleep"
	...
	[ca-certs]="bos fpath ptime mirage-crypto x509 logs digestif ohex"
...
magic-mime logs fmt sexplib0 uri ipaddr core_unix http"
	...
	[cohttp-top]="cohttp"
	[conduit]="astring ipaddr-sexp logs ppx_sexp_conv sexplib0 uri ipaddr"
	[conduit-async]="core async_ssl ipaddr ppx_here ppx_sexp_conv sexplib0 uri conduit async ipaddr-sexp"
	[conduit-async-ssl]="core conduit-async async async_ssl"
	[conduit-async-tls]="core conduit-async async conduit-tls"
	[conduit-lwt]="conduit ppx_sexp_conv sexplib0 lwt"
...
sexplib spawn timezone ppx_optcomp"
	...
	[crowbar]="cmdliner afl-persistent"
	...
	[digestif]="eqaf"
	[dispatch]=""
	[dns]="fmt logs ptime domain-name gmap ohex ipaddr lru duration metrics base64"
	[domain-name]=""
...
js_of_ocaml-tyxml logs tyxml ocsigenserver ipaddr reactiveData ppxlib ocsipersist xml-light"
	...
	[js_of_ocaml-compiler]="cmdliner yojson menhir ppxlib findlib menhirLib menhirSdk sedlex ocaml-compiler-libs"
	...
	[logs-syslog]="cstruct ipaddr logs lwt mirage-kv mirage-ptime ptime syslog-message tcpip tls-lwt tls-mirage x509"
	[lru]="psq"
	[lru_cache]="core ppx_jane"
	[lwt]="ocplib-endian dune-configurator lwt_runtime_events"
	[lwt-dllist]=""
	[lwt_glib]="lwt"
	[lwt_log]="lwt"
	[lwt_ppx]="lwt ppxlib"
	...
	[memtrace]=""
	[menhir]="menhirLib menhirSdk menhirGLR menhirCST"
	[menhirCST]=""
	[menhirGLR]=""
	[menhirLib]=""
	[menhirSdk]=""
	[merlin]="merlin-lib dot-merlin-reader yojson ocaml-index"
	[merlin-lib]="csexp"
	[merlin-extend]=""
	[metrics]="fmt"
	[mew]="trie result"
	...
	[mirage-crypto]="dune-configurator eqaf"
	[mirage-crypto-ec]="digestif eqaf dune-configurator mirage-crypto-rng"
	[mirage-crypto-pk]="digestif mirage-crypto mirage-crypto-rng zarith eqaf"
	[mirage-crypto-rng]="dune-configurator duration digestif logs mirage-crypto"
	[mirage-crypto-rng-lwt]="duration logs lwt mirage-crypto-rng mtime"
	[mirage-device]="fmt lwt"
	[mirage-flow]="cstruct fmt lwt"
	[mirage-kv]="lwt fmt optint ptime"
	[mirage-kv-mem]="fmt mirage-kv ptime mirage-ptime optint"
	[mirage-mtime]="mtime"
	[mirage-net]="cstruct fmt lwt macaddr"
	[mirage-profile]="cstruct lwt ocplib-endian"
	[mirage-profile-unix]="mirage-profile mtime ocplib-endian"
	[mirage-ptime]="ptime"
	[mirage-sleep]="duration lwt"
	[mirage-vnetif]="cstruct duration ipaddr logs lwt macaddr mirage-net"
	...
	[ocamlgraph]=""
	[ocamlgraph_gtk]="lablgtk ocamlgraph"
	...
	[ocsigenserver]="camlzip findlib http react ssl logs logs-syslog lwt lwt_ssl lwt_react re cryptokit ipaddr cohttp-lwt-unix
syslog-message xml-light conduit-lwt-unix"
	[ocsigen-i18n]="ppxlib"
...
cohttp-lwt-unix re ocsigen-ppx-rpc js_of_ocaml ocsipersist-pgsql-config"
	...
	[ocsipersist-pgsql]="ocsipersist lwt logs pgocaml"
	[ocsipersist-pgsql-config]="ocsigenserver ocsipersist-pgsql xml-light"
	[ocsipersist-sqlite]="ocsipersist lwt logs sqlite3"
	[octavius]=""
	[odoc]="astring cmdliner fpath tyxml fmt odoc-parser crunch"
	[odoc-parser]="astring camlp-streams"
	[ohex]=""
	...
	[opam-client]="opam-state re opam-solver base64 opam-repository"
	[opam-core]="sha jsonm uutf ocamlgraph re swhid_core patch"
	[opam-format]="opam-core opam-file-format re"
	[opam-installer]=""
	[opam-repository]="opam-format patch"
	[opam-solver]="opam-format mccs dose3 cudf opam-0install-cudf re"
	[opam-state]="opam-repository re spdx_licenses patch"
	[opam-file-format]="menhir"
	[optint]=""
	[ordering]=""
	...
	[pcre]="dune-configurator dune-compiledb"
	[pcre2]="dune-configurator dune-compiledb"
	...
	[pomap]=""
	[postgresql]="dune-configurator dune-compiledb"
	[pp]="ocamlformat"
	[pprint]=""
...
ppx_ignore_instrumentation ppx_log ppx_string_conv"
	...
	[ppxlib]="ocaml-compiler-libs ppx_derivers sexplib0 stdlib-shims ocamlformat"
	[ppxlib_jane]="ppxlib"
	...
	[react]=""
	[reactiveData]="react"
	[reason]="cppo merlin-extend menhir fix cmdliner dune-build-info ppxlib"
	...
	[sqlite3]="dune-configurator dune-compiledb"
	...
	[stdlib-random]="cppo"
	[stdlib-shims]=""
	[stdune]="csexp dyn ordering pp top-closure fs-io"
	[stringext]=""
	[syslog-message]="ptime"
	[swagger]="atdgen re yojson"
	[swhid_core]=""
	[tcpip]="arp cmdliner cstruct cstruct-lwt duration ethernet fmt ipaddr ipaddr-cstruct logs lru lwt lwt-dllist
macaddr macaddr-cstruct metrics mirage-crypto-rng mirage-flow mirage-mtime mirage-net mirage-sleep randomconv"
	[testo]="cmdliner fpath ocamlformat re testo-util utop"
	[testo-diff]="ppx_deriving"
	[testo-util]="fpath ppx_deriving re testo-diff"
...
domain-name fmt mirage-crypto-ec kdf logs ipaddr ohex ptime"
	...
	[tls-mirage]="fmt lwt mirage-crypto mirage-crypto-pk mirage-kv mirage-flow mirage-ptime ptime tls"
	[topkg]="ocamlbuild"
	[top-closure]=""
	[trie]=""
	[typerep]="base"
	...
	[websocket]="base64 conduit cohttp ocplib-endian astring mirage-crypto-rng"
	...
	[wtf8]=""
	[x509]="asn1-combinators ptime base64 mirage-crypto mirage-crypto-pk mirage-crypto-ec mirage-crypto-rng
kdf fmt gmap domain-name logs ipaddr ohex"
	[xdg]=""
	[xmldiff]="xmlm"
	[xmlm]=""
	[xml-light]=""
...
declare -A -g _GLOBAL_OCAML_TEST_DEPS=(
	...
	[arp]="alcotest bos mirage-vnetif"
	[angstrom]="alcotest ppx_let"
	[asn1-combinators]="alcotest ohex"
	[atd]="alcotest testo"
	...
	[cinaps]="ppx_jane"
	[cohttp]="alcotest fmt"
	[cohttp-async]="core ounit2 digestif"
	...
	[ctypes]="ounit2"
	[ctypes-foreign]="ounit2 integers lwt"
	[cudf]="ounit2"
	...
	[hkdf]="alcotest ohex"
	[http]="alcotest base_quickcheck crowbar ppx_assert ppx_compare ppx_expect ppx_here ppx_sexp_conv sexplib0"
	[io-page]="ounit2"
	[io-page-unix]="ounit2"
	...
	[js_of_ocaml-compiler]="ppx_expect num re qcheck"
	[js_of_ocaml-lwt]="ppx_expect num re"
	[js_of_ocaml-ppx]="ppx_expect num re"
	[js_of_ocaml-ppx_deriving_json]="ppx_expect num re"
	[js_of_ocaml-toplevel]="ppx_expect num re graphics"
	[js_of_ocaml-tyxml]="ppx_expect num re"
	[kdf]="alcotest ohex"
	...
	[mdx]="alcotest lwt"
	[merlin]="ppxlib ppx_string"
	[merlin-lib]="alcotest"
	[metrics]="alcotest"
	[mirage-crypto]="ounit2 ohex"
	[mirage-crypto-ec]="alcotest asn1-combinators ppx_deriving ppx_deriving_yojson yojson ohex ounit2"
	[mirage-crypto-pk]="ounit2 randomconv ohex"
	[mirage-crypto-rng]="ounit2 randomconv ohex"
	[mirage-kv]="alcotest"
	[mirage-kv-mem]="alcotest"
	[msgpck]="alcotest"
	...
	[ocamlmod]="ounit2"
	[ocsigen-i18n]="tyxml"
	[ocsipersist-sqlite]="js_of_ocaml-ppx_deriving_json"
	[odoc]="bos findlib ppx_expect yojson sexplib0"
	[odoc-parser]="ppx_expect sexplib0"
	[ohex]="alcotest"
	[opam-0install-cudf]="alcotest"
	[opam-file-format]="alcotest fmt"
	[optint]="crowbar fmt monolith"
	[owl]="alcotest"
	[patch]="alcotest crowbar"
	[pbkdf]="alcotest ohex"
	[pcap-format]="ounit2"
	[pcre]="ounit2"
	[pcre2]="ounit2"
	...
	[re]="ounit2 ppx_expect js_of_ocaml"
	...
	[syslog-message]="qcheck"
	[tcpip]="alcotest mirage-vnetif pcap-format"
	[testo]="alcotest"
	[tls]="alcotest ounit2 cmdliner"
	[tls-lwt]="randomconv x509"
	[tyxml]="alcotest"
	[tyxml-ppx]="alcotest"
	...
	[utop]="alcotest"
	[uucp]="uucd uunf"
	[x509]="alcotest mirage-crypto-rng"
