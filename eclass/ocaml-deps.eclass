...
declare -A -g _GLOBAL_OCAML_DEPS=(
	...
	[async_ssl]="async base core ppx_jane stdio ocaml-ctypes dune-configurator ppx_optcomp"
...
js_of_ocaml-tyxml lwt_log lwt_ppx tyxml ocsigenserver ipaddr reactiveData ppxlib ocsipersist"
	...
	[hmap]=""
	[incremental]="core_kernel ppx_jane core ppx_optcomp lru_cache"
	...
	[mccs]="cudf"
	[mdx]="fmt findlib astring logs cmdliner re ocaml-version odoc-parser csexp"
	...
	[num]=""
	[ocamlbuild]=""
	[ocamlformat]="cmdliner ocamlformat-lib re"
	[ocamlformat-lib]="astring base camlp-streams csexp dune-build-info either fix fpath menhir menhirLib menhirSdk ocaml-version ocp-indent result stdio uuseg uutf"
...
cohttp-lwt-unix ocamlnet re ocsigen-ppx-rpc"
	...
	[owl]="ocaml-ctypes dune-configurator owl-base npy"
	[owl-base]=""
...
domain-name fmt mirage-crypto-ec hkdf logs ipaddr"
	...
	[utop]="lwt lwt_react lambda-term findlib zed react logs"
	[uucd]="xmlm"
...
declare -A -g _GLOBAL_OCAML_TEST_DEPS=(
	...
	[containers]="csexp gen iter yojson uutf"
	...
	[ocamlformat]="ocamlformat-rpc-lib"
	[ocamlformat-lib]="alcotest ocamlformat-rpc-lib"
