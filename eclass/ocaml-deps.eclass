...
typerep variantslib"
	...
	[dispatch]=""
	[dns]="fmt logs ptime domain-name gmap cstruct ipaddr lru duration metrics"
	[domain-name]=""
...
pbkdf fmt gmap domain-name logs ipaddr"
	...
	[xmlm]=""
	[xml-light]=""
	[yaml]="dune-configurator ocaml-ctypes rresult bos result"
