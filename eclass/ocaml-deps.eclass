...
js_of_ocaml-tyxml lwt_log lwt_ppx tyxml ocsigenserver ipaddr reactiveData ppxlib"
	...
	[num]=""
	[ocamlbuild]=""
	[ocamlformat]="base menhir cmdliner fix fpath ppxlib odoc re stdio uuseg uutf dune-build-info ocaml-version menhirLib menhirSdk ocaml-migrate-parsetree"
...
domain-name fmt lwt ptime hacl_x25519 fiat-p256 hkdf logs"
	...
	[wtf8]=""
	[x509]="cstruct asn1-combinators ptime base64 mirage-crypto mirage-crypto-pk rresult fmt gmap domain-name logs"
	[xmldiff]="xmlm"
	[xmlm]=""
	[xml-light]=""
